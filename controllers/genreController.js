...
exports.genre_create_post = [
	...
	(req, res, next) =>{
		 ...
		 if(!errors.isEmpty()){
		 	//there is errors, render the form again with sanitized error messages
		 	res.render('genre_form', {ttile: 'Create Genre', genre: genre, errors: errors.array()});
		 	return;
		}
		else{
			//data from form is valide
